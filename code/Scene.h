...
private:
	...
	const float MAX_TIME_TO_END = 3.0f;		//  maximum time after shooting before turn is ended
	const float EARTH_RADIUS = 500.0f;
	const int BALLS_PER_TURN = 3;
	...
	void SetupSettings()
	{
		...
		metalBallSettings.mass = piggySettings.mass * 4.0f;
